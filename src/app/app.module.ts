...
import { InitializeApp } from './shared/initialize'
import { CommonInterceptor } from './interceptors/http.interceptor'
...
@NgModule({
  ...
  providers: [
    ...
    { provide: StorageToken, useFactory: StorageProvider, deps: [WindowToken]},
